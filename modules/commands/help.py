...
async def help(client, chat_id, prefix):
    try:
        ...
        field_13 = "* `{}hackear` : Es una broma".format(prefix)
        field_14 = "* `{}block` : Bloquear a un usuario.".format(prefix)
        field_15 = "* `{}unblock` : Desbloquear a un usuario.".format(prefix)
        field_16 = "* `{}security` : Activar o desactivar medidas de seguridad.".format(prefix)
        field_17 = "* `{}setprefix` : Establece un nuevo prefijo para los comandos.".format(prefix)
        field_18 = "* `{}setlanguage` : Establecer un nuevo idioma.".format(prefix)
        ...
        part_2 = "{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}".format(field_11, field_12, field_13, field_14, field_15, field_16, field_17, field_18)
